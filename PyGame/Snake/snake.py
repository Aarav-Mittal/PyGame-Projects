...
class SNAKE():
    ...
    def draw_snake(self):
        ...
        for index,block in enumerate(self.body):
            ...
            if index == 0:   # updating head graphic
                screen.blit(self.head,block_rect)               
            
            elif index == len(self.body)-1: # updating tail graphic
                screen.blit(self.tail,block_rect)              

            else: # updating body graphics
...
bg_music = pygame.mixer.Sound('Snake/Sound/Background.mp3')
bg_music.play(-1)
